                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row gy-3">
                            <div class="col-xl-12">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" id="fullName" placeholder="Full name" required autocomplete="name" autofocus>
                                @error('name')
                            ...
                            <div class="col-xl-12 mb-2">
                                ...
                                <div class="input-group">
                                    <input type="password" class="form-control @error('password') is-invalid @enderror" id="password" placeholder="password" name="password" required autocomplete="password">
                            ...
                            <div class="col-xl-12 mb-2">
                                ...
                                <div class="input-group">
                                    <input type="password" class="form-control @error('password-confirm') is-invalid @enderror" id="password-confirm" placeholder="password confirm" name="password_confirmation" required autocomplete="new-password">
                                    <button class="btn btn-light" onclick="createpassword('password-confirm',this)" type="button" id="button-addon2"><i class="ri-eye-off-line align-middle"></i></button>
                        ...
                        <div class="text-center">
                            <p class="fs-12 text-muted mt-3">Already have an account? <a href="{{ route('login') }}" class="text-primary">Sign In</a></p>
                        </div>
