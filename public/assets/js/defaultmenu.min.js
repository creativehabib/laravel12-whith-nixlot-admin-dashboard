...
(() => {
    ...
    if (
        !localStorage.getItem("Nixlotlayout") &&
        !localStorage.getItem("Nixlotnavstyles") &&
        !localStorage.getItem("Nixlotverticalstyles") &&
    ...
    function rtlFn() {
        ...
        //RTL
        if (localStorage.getItem('Nixlotrtl')) {
            ...
            switch (verticalStyle) {
                ...
                case "overlay":
                    ...
                    if (html.getAttribute('data-toggled') === 'icon-overlay-close') {
                        ...
                        if (window.innerWidth >= 992) {
                            if (!localStorage.getItem("Nixlotlayout")) {
